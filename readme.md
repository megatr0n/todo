...
Execute "php artisan serve --port=8000".
Then navigate to localhost:8000 or go to http://localhost/quickstart/public/index.php.
First, you will need to create at least one project.
Click the ">>Project<<" link at the top of the page. Once that page is fully loaded, create a project.
Now you are ready to create tasks and assign them to projects.
Click the ">>Task<<" link at the top of the page. Once that page is fully loaded, create a task and assign it to a prject.
